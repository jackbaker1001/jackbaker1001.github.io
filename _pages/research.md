...
permalink: /research/
---
<figure class="research-figure align-right">
  <img src="/assets/img/vortex_pzo.png" alt="Polar vortex in the perovskite material lead zirconate">
  <figcaption>Dipolar vortices in antiferroelectric perovskite materials PbZrO<sub>3</sub> and PbHfO<sub>3</sub>.</figcaption>
</figure>

Broadly speaking, if aspects of quantum theory can be advantageously used in/applied to a domain, I pursue it. This can be considered the unifying theme of my research interests, bringing together early fault tolerant algorthims for quantum optimization, chemistry and machine learning and large-scale first principles simulations of solids. The latter of these of these topics was covered in my Ph.D. research. I used massively parallel density functional functional theory codes on large supercomputers to simulate ferroelectric and antiferroelectric systems at unprecedented scale. These simulations provided accurate charecterizations of topological polar textures and revealed new phase transition behaviour in antiferroelectrics. I am still involved in this area, but now spend most of my time ideating and implementing new algorithms for early fault tolerant quantum computers with key applications in the simulation of quantum materials. Another exciting horizon I am working towards is the much anticipated joining of classical high performance computing with quantum computation.
...
<figure class="media-card wide">
  <img src="/assets/img/jack_at_aps.png" alt="Physicist Jack S. Baker at the APS March Meeting in Las Vegas">
  <figcaption class="media-caption">APS March Meeting 2023, Las Vegas, Nevada.</figcaption>
</figure>
<br>
Now that noisy intermediate scale quantum (NISQ) computers have been built, I am working towards making existing and future fault tolerant machines more than mere physics experiments. While <i>quantum supremacy</i> has now been demonstrated using NISQ hardware for various sampling experiments, the practical use of this supremacy is limited. Therefore, we must either learn to use the limited number of noisy qubits we have at hand to do something really useful <i>and</i> plan for the early fault tolerant era where algorithms come with strict performance guarantees.<br><br> 


One promizing area is quantum machine learning (QML). I have developed various QML algorithms suited for NISQ and early fault tolerant hardware for time-series analysis, outlier detection, and others utilizing novel hybrid-quantum classical neural network architectures and multiple kernel learning. Although practical quantum advantage is the end goal, but there are many obstacles along the way. There are, for example, many unsolved problems in fundamental QML research for which I am interested in finding solutions to or at least alleviating including barren plateaus (induced by hardware noise or lack of inductive bias), efficient training of quantum circuits and understanding the generalization bounds of different QML models. <br><br>

<figure class="research-figure align-left">
  <img src="/assets/img/qaoa_mvpo.png" alt="The Quantum Approximate Optimization Algorithm applied to financial portfolio optimization">
  <figcaption>A schematic demonstrating the quantum approximate optimization algorithm applied to portfolio optimization.</figcaption>
</figure>
Another area which intrigues me is the potential for quantum algorithms to approximately solve NP-hard combinatorial optimization problems. Such problems appear everywhere from finance to route optimization so are researched heavily. There are very well-known algorithms for this task (notably the quantum approximate optimization algorithm and quantum annealing) but they face problems at scale. I am therefore interested in (i) enhancing existing approaches using classical deep learning techniques and others (ii) working towards new optimization algorithms in general. My recent research in this area revolves around benchmarking quantum optimization on NISQ hardware for finance applications like portfolio optimization and diversification and exploring new ways for assesing the quality of solutions yielded from these methods.<br><br> 

<figure class="research-figure align-right">
  <img src="/assets/img/qmp_washington.png" alt="The qubit layout for quantum multiprocessing on IBM Washington">
  <figcaption>Many parallelized quantum circuits spread throughout the 127 qubit superconducting transmon quantum computer: ibm_washington.</figcaption>
</figure>
...
<figure class="research-figure align-left">
  <img src="/assets/img/flux_closure_pto_sto.png" alt="Ferroelectric flux closure domains in lead titanate films on strontium titanate substrates">
  <figcaption>Polar vortex-antivortex pairs in PbTiO<sub>3</sub> films on SrTiO<sub>3</sub> substrates. These vector fields were calculated using atomic structures from first-principles DFT.</figcaption>
</figure>
...
<figure class="research-figure align-right">
  <img src="/assets/img/scaling_behaviour.png" alt="The performance of the density functional theory code CONQUEST on large supercomputers">
  <figcaption>Scaling behaviour of the CONQUEST code for different numbers of atoms and cores using PbTiO<sub>3</sub> as a model system. (a) Strong scaling behaviour vs ideal. (b) Linear scaling with system size. (c) Weak scaling behaviour with up to 200,000 physical cores.</figcaption>
</figure>
...
<figure class="research-figure align-left">
  <img src="/assets/img/SoftDispersion.png" alt="Phonon dispersion of the antiferroelectrics lead zirconate and lead hafnate">
  <figcaption>Unstable phonon modes in PbZrO<sub>3</sub> and PbHfO<sub>3</sub>: (a) high-temperature cubic paraelectric structures; (b) low-temperature antiferroelectric structures. The latter is presently regarded as the ground state, but an instability remains near the Z-point in both materials.</figcaption>
</figure>
